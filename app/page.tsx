  ...
  return (
    <>
      {/* ==================================================================
            HERO SECTION
        ================================================================== */}
      <div id="home" className="min-h-screen bg-gradient-to-br from-black via-[#1a0a3b] to-black flex flex-col md:flex-row items-center justify-center px-6 md:px-20 py-10 gap-10">
        ...
        >
          <motion.h3 className="text-purple-400 text-lg mb-2 font-medium tracking-wide" variants={textVariants}>
            Hi, It's me
          </motion.h3>

          <motion.h1 className="text-white text-4xl md:text-6xl font-bold mb-4 leading-tight" variants={textVariants}>
            Umar <span className="text-purple-400">Nadeem</span>
          </motion.h1>

          <motion.h2 className="text-white text-2xl md:text-3xl font-semibold mb-6" variants={textVariants}>
            I'm a{" "}
         ...
         {/* SOCIAL ICONS */}
<motion.div
  className="flex justify-center md:justify-start gap-10 mb-8"
  variants={textVariants}
>
  {/* Instagram */}
  <a
    href="https://www.instagram.com/umar_n24"
    target="_blank"
    rel="noopener noreferrer"
    className="w-16 h-16 flex items-center justify-center rounded-full bg-purple-900/30 hover:bg-purple-500/30 transition"
  >
    <img src="/instagram.png" className="w-10 h-10" />
  </a>

  {/* GitHub */}
  <a
    href="https://github.com/umar24012003"
    target="_blank"
    rel="noopener noreferrer"
    className="w-16 h-16 flex items-center justify-center rounded-full bg-purple-900/30 hover:bg-purple-500/30 transition"
  >
  ...
  >
    <img src="/linkedin.png" className="w-10 h-10" />
      ...
      <style jsx>{`
        .blinking-cursor { width: 1px; background: #c084fc; animation: blink 0.8s infinite; }
...
>
  <motion.h1
    className="text-4xl md:text-5xl font-bold mb-12 flex  ml-125 gap-3 text-center"
  ...
  <div className="flex flex-col md:flex-row items-center justify-center gap-20">
    ...
    >
      ...
      <p className="text-gray-300 leading-relaxed text-lg">
        I’m a Full Stack Developer from Gujrat, Pakistan. Currently pursuing a
        Computer Science degree. I love creating smooth, clean, and modern
        digital experiences.
      </p>

      {/* INFO GRID */}
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-lg mt-3">
        <p><span className="font-semibold text-purple-400">Age:</span> 22</p>
        <p><span className="font-semibold text-purple-400">Email:</span> umarnadeem24@icloud.com</p>
        <p><span className="font-semibold text-purple-400">Phone:</span> +92 3147865460</p>
        <p><span className="font-semibold text-purple-400">Place:</span> Gujrat, Pakistan</p>
      </div>
...
{ name: "Next.js", icon: "nextjs.png", angle: 120 },
...
{/* ==================================================================
       EXPERIENCE SECTION (SCROLL ANIMATED TIMELINE)
================================================================== */}
<motion.section
   id="Experience" className="w-full px-6 md:px-20 py-20 bg-gradient-to-b from-black via-[#0d001a] to-black text-white"
>
  {/* TITLE */}
  <motion.h1
    className="text-4xl md:text-5xl font-bold mb-16 text-center flex items-center justify-center gap-3"
  ...
  <div className="relative w-full max-w-4xl mx-auto">
    ...
    <div className="space-y-20">
      ...
      {/* EXPERIENCE 1 - RIGHT */}
      <motion.div
        className="relative w-full flex justify-start md:justify-end"
      ...
      >
        <div className="w-full md:w-[45%] bg-[#150024]/60 border border-purple-700/40 rounded-xl p-6 shadow-[0_0_25px_#7c3aed] backdrop-blur-lg">
          <h2 className="text-2xl font-bold text-purple-400">React Developer at Technoo Denmark</h2>
          <p className="text-gray-300 text-sm mt-1">17July2024-20Sep2024</p>
          <p className="mt-3 text-gray-300 leading-relaxed">
            Create The Company Website,Using React Different States 
            to Manage there different Functionalities
          </p>
        </div>
      ...
      >
        <div className="w-full md:w-[45%] bg-[#150024]/60 border border-purple-700/40 rounded-xl p-6 shadow-[0_0_25px_#7c3aed] backdrop-blur-lg">
          <h2 className="text-2xl font-bold text-purple-400">Front-End Developer at Twinspider</h2>
          <p className="text-gray-300 text-sm mt-1">2022 – 2025</p>
          <p className="mt-3 text-gray-300 leading-relaxed">
            Built dynamic components, custom hooks, and optimized full front-end architectures.
          </p>
        </div>
        <span className="absolute left-1/2 top-6 w-5 h-5 bg-purple-500 rounded-full transform -translate-x-1/2 shadow-[0_0_15px_#a78bfa]"></span>
      </motion.div>
      ...
      >
        <div className="w-full md:w-[45%] bg-[#150024]/60 border border-purple-700/40 rounded-xl p-6 shadow-[0_0_25px_#7c3aed] backdrop-blur-lg">
          <h2 className="text-2xl font-bold text-purple-400">Full Stack Developer At Abcdmedia</h2>
          <p className="text-gray-300 text-sm mt-1">2025 – Present</p>
          <p className="mt-3 text-gray-300 leading-relaxed">
            Working with MERN stack, building APIs, dashboards, auth systems & production-grade web apps.
          </p>
        </div>
        <span className="absolute left-1/2 top-6 w-5 h-5 bg-purple-500 rounded-full transform -translate-x-1/2 shadow-[0_0_15px_#a78bfa]"></span>
      </motion.div>
      ...
      >
        <div className="w-full md:w-[45%] bg-[#150024]/60 border border-purple-700/40 rounded-xl p-6 shadow-[0_0_25px_#7c3aed] backdrop-blur-lg">
          <h2 className="text-2xl font-bold text-purple-400">Final Year Project</h2>
          <p className="text-gray-300 text-sm mt-1">2025 – Present</p>
          <p className="mt-3 text-gray-300 leading-relaxed">
            Designing business application where entrepreneur and investers and collaborate
            and also we can rise a funding campaigns for various victims...
          </p>
        </div>
        <span className="absolute left-1/2 top-6 w-5 h-5 bg-purple-500 rounded-full transform -translate-x-1/2 shadow-[0_0_15px_#a78bfa]"></span>
      </motion.div>
...
<button onClick={() => setOpenResume(false)} className="absolute top-3 right-3 text-white text-2xl hover:text-purple-400">✖</button>
